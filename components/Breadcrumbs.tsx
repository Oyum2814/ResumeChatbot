    ...
    return ( 
        ...
        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          <li className="inline-flex items-center">
            <a href="/" className="inline-flex items-center text-sm font-medium  hover:text-blue-600 dark: dark:hover:text-blue-600">
            ...
            resume && (
                <>
                    <li>
                        ...
                        <a href="/templates" className="ms-1 text-sm font-medium  hover:text-blue-600 md:ms-2 dark: dark:hover:text-blue-600">Templates</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div className="flex items-center">
                        ...
                        <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:">{resumeName}</span>
                        </div>
                    </li>
                </>
            )
