        ...
        <div className={`scale-[50%] md:scale-[75%] ${loading?'':'shadow-xl border-[1px]'} `}>
          <Doc file={pdfUrl}
           loading={() => {
              setLoading(true);
              return (
                <svg aria-hidden="true" className="shadow-none border-none w-16 h-16 text-gray-200 animate-spin  fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
